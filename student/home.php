      ...
      <table width="98%" border="0" cellspacing="0" cellpadding="10">
        ...
        <tr>
          <td width="25%"><div align="center">
              ...
              <tr>
                <td id="box_border" width="283px" valign="top" align="center"><div align="center">
                    <table border="0" width="283px" align="center" style="margin:5px;">
                      <? ini_set('error_reporting', E_ALL ^ ~E_NOTICE ^ ~E_WARNING);
			include("./config.php");
			$result=mysql_query("select * from query where studid='".$_SESSION['cuser']."' order by querydate desc limit 0,5");
			...
			{
						echo"<tr><td align=center width=25%>No Queries</td></tr>";
			}	
		?>
		...
		?>
          ...
          <td width="25%"><div align="center">
			...
			include("./config.php");
			  ini_set('error_reporting', E_ALL ^ ~E_NOTICE ^ ~E_WARNING);
			$result=mysql_query("select * from assignment where studsemester='".$_SESSION['sem']."' order by assigndate desc  limit 0,5");
			if(mysql_num_rows($result)>0)
			{
				while($row=mysql_fetch_array($result))
				{
			...
			{
					echo"<tr><td align=center width=25%>No Assignments</td></tr>";
			}
