<?
	...
	chk_user();
	$id=$_GET['id'];
	$result=mysql_query("select * from query where queryid=$id");
          ...
          <table width="902" border="0" cellspacing="0" cellpadding="0" style="margin:10px;">
            ...
            <tr>
              <td id="profile_mid" valign="top"><div align="center">
              	<form action="./queries_edit_db.php" method="post" name="form1" id="form1" onsubmit="return ValidateForm()">
            <input type="hidden" name="login" value="<?=$_SESSION['cuser']; ?>" />
            <input type="hidden" name="id" value="<?=$row['queryid']; ?>" />            
            <table width="900" height="223" border="0" align="center" cellpadding="0" cellspacing="0">
