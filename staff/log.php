    ...
    <td id="mid" valign="top"><table width="900" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td width="817" id="head_txt"><div align="left">
          <div align="left" class="style2">&nbsp;Log Management</div>
        </div></td>
      ...
      <tr>
        ...
        <? ini_set('error_reporting', E_ALL ^ ~E_NOTICE ^ ~E_WARNING);
			...
			{
				echo"<tr><td align=center width=28%>".$row['loginid']."</td><td align=center width=34%>".$row['logindate']." ".$row['logintime']."</td><td align=center>".$row['logoutdate']." ".$row['logouttime']."</td></tr>";
			}
