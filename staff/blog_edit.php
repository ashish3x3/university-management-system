      ...
      <tr>
        ...
        <table width="902" border="0" cellspacing="0" cellpadding="0" style="margin:10px;">
            ...
            <tr>
              ...
              <form name="form1" method="post" action="./blog_edit_db.php" >
	        <input type="hidden" name="id" value="<?=$id; ?>">      
        <table width="900" height="277" border="0" align="center" cellpadding="0" cellspacing="0">
          
          
          <tr>
            <td colspan="3" id="head_txt">Edit Blog</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td width="309"><div align="left">
                <label>
                <input name="subject" type="text" size="50" value="<?=$row['blogsubject']; ?>" />
                </label>
            </div></td>
	            <td width="195">&nbsp;</td>
          </tr>
          <tr>
            ...
            <td><div align="left">
                <textarea name="blog_text" cols="35" rows="4" id="textfield3"><?=$row['blogtext']; ?></textarea>
            </div></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td height="37" colspan="3"><div align="center">
                ...
                <label>
                <input type="button" name="button2" id="but_sub" value="CANCEL" onclick="location.href='./blog.php'" />
                </label>
            </div></td>
          </tr>
          <tr>
